  ...
  if(c_do_detailed_output)
    {
      ...
      DeclareVariable(m_el_raw_topoetcone20_corrected, "el_raw_topoetcone20_corrected");
      DeclareVariable(m_el_raw_topoetcone30_corrected, "el_raw_topoetcone30_corrected");
      DeclareVariable(m_el_raw_topoetcone40_corrected, "el_raw_topoetcone40_corrected");
...
// ----------------------------------------------------------------------------
void CommonTools::ElectronOutputTool::BeginExecuteEvent( const SInputData&, Double_t )
{
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
// ----------------------------------------------------------------------------
void CommonTools::ElectronOutputTool::fillOutput(Event* event, ElectronContainer electrons, MuonContainer muons, JetContainer jets, Met*, VertexContainer vertices)
{
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  m_logger << VERBOSE
  ...
  for (size_t el_it=0; el_it != num_el; ++el_it) 
    {
      ...
      //TO DO:  cf smeared pt -- for now indentical to regular pt
