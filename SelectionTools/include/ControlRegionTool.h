...
#ifndef SelectionTools_ControlRegionTool_h
#define SelectionTools_ControlRegionTool_h
...
{
  // ===========================================================================
  class ControlRegionTool : public ToolBase
  {
  // ---------------------------------------------------------------------------
  public:
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ControlRegionTool( SCycleBase* parent
                    , const char* name = "EventCleaning"
                    );
    virtual ~ControlRegionTool();

    void BeginInputData( const SInputData& id);
    void EndInputData(   const SInputData& id);

    void processControlRegions( Event*
                              , ElectronContainer&
                              , MuonContainer&
                              , JetContainer&
                              , Met*
