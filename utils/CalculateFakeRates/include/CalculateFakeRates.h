...
class CalculateFakeRates : public NtupleHelper::NtupleLooper
{
  ...
  private:
    ...
    TH1D* m_el_re_HIGGS;
    TH1D* m_el_re_STRONG;
    TH1D* m_el_re_STRONG_30;
    TH1D* m_el_re_numer_EWK;
    TH1D* m_el_re_numer_HIGGS;
    TH1D* m_el_re_numer_STRONG;
    TH1D* m_el_re_numer_STRONG_30;
    TH1D* m_el_re_denom;

    TH1D* m_mu_re_EWK;
    TH1D* m_mu_re_HIGGS;
    TH1D* m_mu_re_STRONG;
    TH1D* m_mu_re_STRONG_30;
    TH1D* m_mu_re_numer_EWK;
    TH1D* m_mu_re_numer_HIGGS;
    TH1D* m_mu_re_numer_STRONG;
    TH1D* m_mu_re_numer_STRONG_30;
    TH1D* m_mu_re_denom;

    TH1D* m_el_fr_EWK;
    TH1D* m_el_fr_HIGGS;
    TH1D* m_el_fr_STRONG;
    TH1D* m_el_fr_STRONG_30;
    TH1D* m_el_fr_numer_EWK;
    TH1D* m_el_fr_numer_HIGGS;
    TH1D* m_el_fr_numer_STRONG;
    TH1D* m_el_fr_numer_STRONG_30;
    TH1D* m_el_fr_denom;

    TH1D* m_mu_fr_EWK;
    TH1D* m_mu_fr_HIGGS;
    TH1D* m_mu_fr_STRONG;
    TH1D* m_mu_fr_STRONG_30;
    TH1D* m_mu_fr_numer_EWK;
    TH1D* m_mu_fr_numer_HIGGS;
    TH1D* m_mu_fr_numer_STRONG;
    TH1D* m_mu_fr_numer_STRONG_30;
    TH1D* m_mu_fr_denom;
};
