...
#   -w results/SampleBkg_bre_50_brm_50_brt_0_blind/BkgOnly_combined_NormalMeasurement_model_afterFit.root \
...
YieldsTable.py \
  ...
  -s ttbar,ZGamma,SingleTop,Other \
  -w results/SampleBkg_bre_50_brm_50_brt_0_unblind/BkgOnly_combined_NormalMeasurement_model_afterFit.root \
...
## 
## YieldsTable.py \
##   -c SR_ht_1100_mbl_400_all_mbl_0,SR_ht_1100_mbl_400_ee_mbl_0,SR_ht_1100_mbl_400_mm_mbl_0,SR_ht_1100_mbl_400_em_mbl_0 \
##   -s ttbar,ZGamma,SingleTop,Other \
##   -w results/SampleBkg_bre_50_brm_50_brt_0_blind/BkgOnly_combined_NormalMeasurement_model_afterFit.root \
##   -o YieldTable/MyYieldTable.SR_400_detail.tex
## 
## YieldsTable.py \
##   -c SR_ht_1100_mbl_600_all_mbl_0,SR_ht_1100_mbl_600_ee_mbl_0,SR_ht_1100_mbl_600_mm_mbl_0,SR_ht_1100_mbl_600_em_mbl_0 \
##   -s ttbar,ZGamma,SingleTop,Other \
##   -w results/SampleBkg_bre_50_brm_50_brt_0_blind/BkgOnly_combined_NormalMeasurement_model_afterFit.root \
##   -o YieldTable/MyYieldTable.SR_600_detail.tex
## 
##   ## -w results/SampleBkg_bre_50_brm_50_brt_0_unblind/BkgOnly_combined_NormalMeasurement_model_afterFit.root \
##   ## -w results/SampleBkg_bre_50_brm_50_brt_0_blind/BkgOnly_combined_NormalMeasurement_model_afterFit.root \
