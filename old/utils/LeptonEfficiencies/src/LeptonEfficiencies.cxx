#include "LeptonEfficiencies/include/LeptonEfficiencies.h"
...
// -----------------------------------------------------------------------------
LeptonEfficiencies::LeptonEfficiencies( TTree *tree
                                , double num_events
...
// -----------------------------------------------------------------------------
LeptonEfficiencies::~LeptonEfficiencies()
{
  // do nothing
}

// -----------------------------------------------------------------------------
void LeptonEfficiencies::addCut( std::string key
...
// -----------------------------------------------------------------------------
void LeptonEfficiencies::processEvent()
{
  // do nothing
}

// // -----------------------------------------------------------------------------
// void LeptonEfficiencies::writeToFile()
// {
...
// 
// // -----------------------------------------------------------------------------
// void LeptonEfficiencies::writeToFile(std::string key, TTree* tree_to_write)
// {
//   m_out_file->cd();
...
// -----------------------------------------------------------------------------
void LeptonEfficiencies::filterTree(std::string key)
{
