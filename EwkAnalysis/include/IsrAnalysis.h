#ifndef ISRANALYSIS_H
#define ISRANALYSIS_H
...
namespace PennSusyFrame
{
  ...
  enum ISR_HIST_LEVELS { ISR_HIST_ZVETO
			 , ISR_HIST_MET
			 , ISR_HIST_N
  };

  const std::string ISR_HIST_LEVEL_STRINGS[] = {"ISR_ZVETO"
						, "ISR_MET"
  };


  // ===========================================================================
  class IsrAnalysis : public PennSusyFrame::PennSusyFrameCore
  {
    public :
      IsrAnalysis(TTree *tree=0);
      virtual ~IsrAnalysis();
    ...
    protected:
      ...
      void fillHistHandles(ISR_HIST_LEVELS
			   , float weight
			   );
      ...
      IsrCutFlowTracker m_raw_cutflow_tracker;
      IsrCutFlowTracker m_cutflow_tracker;
      ...
      std::vector<PennSusyFrame::EwkHists*> m_isr_histogram_handler;
