...
void PennSusyFrame::BMinusLAnalysis::beginRun()
{
  ...
  m_dr.PennSusyFrame::DRStudies::init();
}
...
// -------- DR Studies ---------------------------------------------------------
// -----------------------------------------------------------------------------
PennSusyFrame::DRStudies::DRStudies()
{}

PennSusyFrame::DRStudies::~DRStudies()
{}

void PennSusyFrame::DRStudies::init() {
...
void PennSusyFrame::DRStudies::reproduceFullObjectCleaning(const PennSusyFrame::Event& m_event
...
void PennSusyFrame::DRStudies::filldRHistHandles(BMINUSL_DR_HIST_LEVELS hist_level
