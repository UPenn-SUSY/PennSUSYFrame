...
if __name__ == '__main__':
    ...
    egamma_data_samples = SamplesDicts.getEgammaDataSamples(job_multiplier=1, test_subset=True)
    muon_data_samples = SamplesDicts.getMuonDataSamples(job_multiplier=1, test_subset=True)
    full_sim_mc_samples = {}
    fast_sim_mc_samples = SamplesDicts.getFastSimSamples(test_subset=True)
    ...
    for syst in systematic_runs:
        ...
        data_set_dicts[syst_tag] = RunHelpers.addAllSamplesToList(
                ...
                file_list_path_base = 'EosFileLists/bminusl_ttnt_107/ttnt',
