    ...
    for lep_pt in [40.e3]:
        for jet_pt in [40.e3]:
            ...
            full_sim_mc_samples = { 110817:{'label':'110817.AlpgenPythia_P2011C_ZeebbNp0'    , 'num_jobs':1}
                                  ...
                                  , 117050:{'label':'117050.PowhegPythia_P2011C_ttbar'                , 'num_jobs':20}
                                  , 200332:{'label':'200332.AlpgenPythia_Auto_P2011C_ZeebbNp0'        , 'num_jobs':15}
                                  ...
                                  , 200340:{'label':'200340.AlpgenPythia_Auto_P2011C_ZmumubbNp0'      , 'num_jobs':15}
                                  ...
                                  , 108346:{'label':'108346.McAtNloJimmy_AUET2CT10_SingleTopWtChanIncl', 'num_jobs':15}
                                  }
            fast_sim_mc_samples = { 105200:{'label':'105200.McAtNloJimmy_CT10_ttbar_LeptonFilter', 'num_jobs':20}
                                  }
