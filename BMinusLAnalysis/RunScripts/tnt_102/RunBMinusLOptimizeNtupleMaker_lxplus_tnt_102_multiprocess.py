...
out_dir = 'hists/bminusl_opt_ntup_%04d_%02d_%02d__%02d_%02d' % ( today_date.year
                                                               , today_date.month
                                                               , today_date.day
                                                               , today_date.hour
                                                               , today_date.minute
...
if __name__ == '__main__':
    ...
    p.map(RunBMinusLOptimizeNtupleMaker.runBMinusLOptimizeNtupleMakerFun, data_set_dicts)

    # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    RunHelpers.mergeOutputFiles(out_dir, True)
    RunHelpers.moveToLinkedDir(out_dir, './NextOptNtupDir.BMinusL')
