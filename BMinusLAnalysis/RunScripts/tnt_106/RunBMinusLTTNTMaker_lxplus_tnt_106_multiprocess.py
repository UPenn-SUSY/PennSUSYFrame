...
if __name__ == '__main__':
    ...
    full_sim_mc_samples = {
                          ...
                          # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
                          , 177997:{'label':'177997.Sherpa_CT10_llnunu_WW_MassiveCB'      , 'num_jobs':10}
                          , 177999:{'label':'177999.Sherpa_CT10_llnunu_ZZ_MassiveCB'      , 'num_jobs':10}
                          , 179974:{'label':'179974.Sherpa_CT10_lllnu_WZ_MassiveCB'       , 'num_jobs':10}
                          , 179975:{'label':'179975.Sherpa_CT10_lnununu_WZ_MassiveCB'     , 'num_jobs':10}
                          # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
                          , 183589:{'label':'183589.Sherpa_CT10_ZWtotautauqq_MassiveCB' , 'num_jobs':10}
