...
if __name__ == '__main__':
    ...
    egamma_data_samples = SampleDicts.getEgammaDataSamples(job_multiplier = 2)
    muon_data_samples = SampleDicts.getMuonDataSamples(job_multiplier = 2)
    full_sim_mc_samples = SampleDicts.getFullSimSamples(job_multiplier = 2)
    fast_sim_mc_samples = SampleDicts.getFastSimSamples(job_multiplier = 2)
