...
if __name__ == '__main__':
    ...
    egamma_data_samples = SamplesDicts.getEgammaDataSamples(job_multiplier = 2)
    muon_data_samples = SamplesDicts.getMuonDataSamples(job_multiplier = 2)
    full_sim_mc_samples = SamplesDicts.getFullSimSamples(job_multiplier = 2)
    fast_sim_mc_samples = SamplesDicts.getFastSimSamples(job_multiplier = 2)
