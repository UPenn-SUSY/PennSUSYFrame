...
if __name__ == '__main__':
    ...
    # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    if run_local:
        RunHelpers.runLocalMultiprocess( run_analysis_fun = RunBMinusLAnalysisLooseJets.runBMinusLAnalysisLooseJetsFun
        ...
        RunHelpers.runLxBatchMultiProcess( run_analysis_fun      = RunBMinusLAnalysisLooseJets.runBMinusLAnalysisLooseJetsFun
                                         ...
                                         , queue                 = '1nh'
                                         , sym_link_name         = './NextPlotDir.BMinusL.LooseJets'
                                         , job_dir               = 'LatestRunDir_bminuslanalysis_loose_jets'
                                         )
