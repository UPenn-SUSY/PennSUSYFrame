...
if __name__ == '__main__':
    ...
    fast_sim_mc_samples = {
                          ...
                          ## , 110101:{'label':'110101.AcerMCPythia_P2011CCTEQ6L1_singletop_tchan_l'       , 'num_jobs':20}
                          ## , 110119:{'label':'110119.PowhegPythia_P2011C_st_schan_lep'                   , 'num_jobs':20}
                          ## # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
                          ## , 167749:{'label':'167749.Sherpa_CT10_ZeeMassiveCBPt0_BFilter'                , 'num_jobs':30}
                          ## , 167750:{'label':'167750.Sherpa_CT10_ZeeMassiveCBPt0_CFilterBVeto'           , 'num_jobs':10}
                          ## , 167751:{'label':'167751.Sherpa_CT10_ZeeMassiveCBPt0_CVetoBVeto'             , 'num_jobs':10}

                          ## , 167752:{'label':'167752.Sherpa_CT10_ZmumuMassiveCBPt0_BFilter'              , 'num_jobs':30}
                          ## , 167753:{'label':'167753.Sherpa_CT10_ZmumuMassiveCBPt0_CFilterBVeto'         , 'num_jobs':10}
                          ## , 167754:{'label':'167754.Sherpa_CT10_ZmumuMassiveCBPt0_CVetoBVeto'           , 'num_jobs':10}
                          ...
                          ## , 167797:{'label':'167797.Sherpa_CT10_ZeeMassiveCBPt70_140_BFilter'           , 'num_jobs':30}
    ...
    print syst_struct.getRunName()

    syst_struct.syst_list['do_jer'] = True
    syst_struct.printInfo()
    print syst_struct.getRunName()

    syst_struct.syst_list['do_jes_up'] = True
    syst_struct.printInfo()
    print syst_struct.getRunName()
