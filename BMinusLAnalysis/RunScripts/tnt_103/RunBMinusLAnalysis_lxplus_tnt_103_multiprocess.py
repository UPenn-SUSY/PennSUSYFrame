...
if __name__ == '__main__':
    ...
    egamma_data_samples = {
                          ...
                          , 'periodG_egamma':{'label':'periodG_egamma', 'num_jobs':15}
                          , 'periodH_egamma':{'label':'periodH_egamma', 'num_jobs':15}
                          , 'periodI_egamma':{'label':'periodI_egamma', 'num_jobs':15}
                          , 'periodJ_egamma':{'label':'periodJ_egamma', 'num_jobs':15}
                          , 'periodL_egamma':{'label':'periodL_egamma', 'num_jobs':15}
                          }
    muon_data_samples = {
                        ...
                        , 'periodG_muon':{'label':'periodG_muon', 'num_jobs':15}
                        , 'periodH_muon':{'label':'periodH_muon', 'num_jobs':15}
                        , 'periodI_muon':{'label':'periodI_muon', 'num_jobs':15}
                        , 'periodJ_muon':{'label':'periodJ_muon', 'num_jobs':15}
                        , 'periodL_muon':{'label':'periodL_muon', 'num_jobs':15}
                        }
    full_sim_mc_samples = {
                          # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
                            173045:{'label':'173045.Sherpa_CT10_DYtautauM08to15' , 'num_jobs':10}
                          , 173046:{'label':'173046.Sherpa_CT10_DYtautauM15to40' , 'num_jobs':10}
                          # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    fast_sim_mc_samples = {
                          ...
                          , 167750:{'label':'167750.Sherpa_CT10_ZeeMassiveCBPt0_CFilterBVeto'           , 'num_jobs':50}
                          , 167751:{'label':'167751.Sherpa_CT10_ZeeMassiveCBPt0_CVetoBVeto'             , 'num_jobs':50}

                          , 167752:{'label':'167752.Sherpa_CT10_ZmumuMassiveCBPt0_BFilter'              , 'num_jobs':50}
                          , 167753:{'label':'167753.Sherpa_CT10_ZmumuMassiveCBPt0_CFilterBVeto'         , 'num_jobs':50}
                          , 167754:{'label':'167754.Sherpa_CT10_ZmumuMassiveCBPt0_CVetoBVeto'           , 'num_jobs':50}

                          , 167755:{'label':'167755.Sherpa_CT10_ZtautauMassiveCBPt0_BFilter'            , 'num_jobs':5}
                          , 167756:{'label':'167756.Sherpa_CT10_ZtautauMassiveCBPt0_CFilterBVeto'       , 'num_jobs':5}
                          , 167757:{'label':'167757.Sherpa_CT10_ZtautauMassiveCBPt0_CVetoBVeto'         , 'num_jobs':5}

                          , 167797:{'label':'167797.Sherpa_CT10_ZeeMassiveCBPt70_140_BFilter'           , 'num_jobs':50}
                          , 167798:{'label':'167798.Sherpa_CT10_ZeeMassiveCBPt70_140_CFilterBVeto'      , 'num_jobs':50}
                          , 167799:{'label':'167799.Sherpa_CT10_ZeeMassiveCBPt70_140_CVetoBVeto'        , 'num_jobs':50}

                          , 167800:{'label':'167800.Sherpa_CT10_ZmumuMassiveCBPt70_140_BFilter'         , 'num_jobs':30}
                          , 167801:{'label':'167801.Sherpa_CT10_ZmumuMassiveCBPt70_140_CFilterBVeto'    , 'num_jobs':30}
                          , 167802:{'label':'167802.Sherpa_CT10_ZmumuMassiveCBPt70_140_CVetoBVeto'      , 'num_jobs':30}

                          , 167803:{'label':'167803.Sherpa_CT10_ZtautauMassiveCBPt70_140_BFilter'       , 'num_jobs':5}
                          , 167804:{'label':'167804.Sherpa_CT10_ZtautauMassiveCBPt70_140_CFilterBVeto'  , 'num_jobs':5}
                          , 167805:{'label':'167805.Sherpa_CT10_ZtautauMassiveCBPt70_140_CVetoBVeto'    , 'num_jobs':5}

                          , 167809:{'label':'167809.Sherpa_CT10_ZeeMassiveCBPt140_280_BFilter'          , 'num_jobs':10}
                          , 167810:{'label':'167810.Sherpa_CT10_ZeeMassiveCBPt140_280_CFilterBVeto'     , 'num_jobs':10}
                          , 167811:{'label':'167811.Sherpa_CT10_ZeeMassiveCBPt140_280_CVetoBVeto'       , 'num_jobs':10}

                          , 167812:{'label':'167812.Sherpa_CT10_ZmumuMassiveCBPt140_280_BFilter'        , 'num_jobs':10}
                          , 167813:{'label':'167813.Sherpa_CT10_ZmumuMassiveCBPt140_280_CFilterBVeto'   , 'num_jobs':10}
                          , 167814:{'label':'167814.Sherpa_CT10_ZmumuMassiveCBPt140_280_CVetoBVeto'     , 'num_jobs':10}

                          , 167815:{'label':'167815.Sherpa_CT10_ZtautauMassiveCBPt140_280_BFilter'      , 'num_jobs':5}
                          , 167816:{'label':'167816.Sherpa_CT10_ZtautauMassiveCBPt140_280_CFilterBVeto' , 'num_jobs':5}
                          , 167817:{'label':'167817.Sherpa_CT10_ZtautauMassiveCBPt140_280_CVetoBVeto'   , 'num_jobs':5}

                          , 167821:{'label':'167821.Sherpa_CT10_ZeeMassiveCBPt280_500_BFilter'          , 'num_jobs':10}
                          , 167822:{'label':'167822.Sherpa_CT10_ZeeMassiveCBPt280_500_CFilterBVeto'     , 'num_jobs':10}
                          , 167823:{'label':'167823.Sherpa_CT10_ZeeMassiveCBPt280_500_CVetoBVeto'       , 'num_jobs':10}

                          , 167824:{'label':'167824.Sherpa_CT10_ZmumuMassiveCBPt280_500_BFilter'        , 'num_jobs':10}
                          , 167825:{'label':'167825.Sherpa_CT10_ZmumuMassiveCBPt280_500_CFilterBVeto'   , 'num_jobs':10}
                          , 167826:{'label':'167826.Sherpa_CT10_ZmumuMassiveCBPt280_500_CVetoBVeto'     , 'num_jobs':10}

                          , 167827:{'label':'167827.Sherpa_CT10_ZtautauMassiveCBPt280_500_BFilter'      , 'num_jobs':5}
                          , 167828:{'label':'167828.Sherpa_CT10_ZtautauMassiveCBPt280_500_CFilterBVeto' , 'num_jobs':5}
                          , 167829:{'label':'167829.Sherpa_CT10_ZtautauMassiveCBPt280_500_CVetoBVeto'   , 'num_jobs':5}

                          , 167833:{'label':'167833.Sherpa_CT10_ZeeMassiveCBPt500_BFilter'              , 'num_jobs':10}
                          , 167834:{'label':'167834.Sherpa_CT10_ZeeMassiveCBPt500_CFilterBVeto'         , 'num_jobs':10}
                          , 167835:{'label':'167835.Sherpa_CT10_ZeeMassiveCBPt500_CVetoBVeto'           , 'num_jobs':10}

                          , 167836:{'label':'167836.Sherpa_CT10_ZmumuMassiveCBPt500_BFilter'            , 'num_jobs':10}
                          , 167837:{'label':'167837.Sherpa_CT10_ZmumuMassiveCBPt500_CFilterBVeto'       , 'num_jobs':10}
                          , 167838:{'label':'167838.Sherpa_CT10_ZmumuMassiveCBPt500_CVetoBVeto'         , 'num_jobs':10}

                          , 167839:{'label':'167839.Sherpa_CT10_ZtautauMassiveCBPt500_BFilter'          , 'num_jobs':5}
                          , 167840:{'label':'167840.Sherpa_CT10_ZtautauMassiveCBPt500_CFilterBVeto'     , 'num_jobs':5}
                          , 167841:{'label':'167841.Sherpa_CT10_ZtautauMassiveCBPt500_CVetoBVeto'       , 'num_jobs':5}
                          ...
                          , 180550:{'label':'180550.Sherpa_CT10_ZtautauMassiveCBPt40_70_CFilterBVeto'   , 'num_jobs':5}
                          , 180551:{'label':'180551.Sherpa_CT10_ZtautauMassiveCBPt40_70_CVetoBVeto'     , 'num_jobs':5}

                          # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
                          , 173041:{'label':'173041.Sherpa_CT10_DYeeM08to15'     , 'num_jobs':10}
                          , 173042:{'label':'173042.Sherpa_CT10_DYeeM15to40'     , 'num_jobs':10}

                          , 173043:{'label':'173043.Sherpa_CT10_DYmumuM08to15'   , 'num_jobs':10}
                          , 173044:{'label':'173044.Sherpa_CT10_DYmumuM15to40'   , 'num_jobs':10}
