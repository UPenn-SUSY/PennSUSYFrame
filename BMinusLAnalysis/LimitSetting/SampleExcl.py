...
# gROOT.LoadMacro("/afs/cern.ch/atlas/project/cern/susy2/SPyRoot/susy12a_razor_p1328/HistFitter/macros/AtlasStyle.C")
import ROOT
ROOT.SetAtlasStyle()
gROOT.SetBatch(True)
...
# Group backgrounds
bgGroups = {}
#bgGroups = {'W':['Wjets','Wb'],'ttbar':['Top','ttbarV','SingleTop']}
#bgGroups = {'W':['Wjets','Wb'],'ttbar':['Top','ttbarV']}
crGroups = {
#~~ 'CR-8j50-0bjet':['CRele-8j50-0bjet','CRmu-8j50-0bjet'],
#~~ 'CR-8j50-1bjet':['CRele-8j50-1bjet','CRmu-8j50-1bjet'],
#~~ 'CR-8j50-2bjet':['CRele-8j50-2bjet','CRmu-8j50-2bjet'],
#~~ 'CR-9j50-0bjet':['CRele-9j50-0bjet','CRmu-9j50-0bjet'],
#~~ 'CR-9j50-1bjet':['CRele-9j50-1bjet','CRmu-9j50-1bjet'],
#~~ 'CR-9j50-2bjet':['CRele-9j50-2bjet','CRmu-9j50-2bjet'],
#~~ 
#~~ 'Nj50-topW-0ebtag-CR':['Nj50-e-topW-0ebtag-CR','Nj50-mu-topW-0ebtag-CR'],
#~~ 'Nj50-topW-1ibtag-CR':['Nj50-e-topW-1ibtag-CR','Nj50-mu-topW-1ibtag-CR'],
#~~ 'Nj50-Z-0ebtag-CR':['Nj50-e-Z-0ebtag-CR','Nj50-mu-Z-0ebtag-CR'],
#~~ 'Nj50-Z-1ibtag-CR':['Nj50-e-Z-1ibtag-CR','Nj50-mu-Z-1ibtag-CR'],
      }
...
#~~ mu_samples = ['ttbar','Wjets']
#~~ if 'MJ' in asetup and ('9ij50' in asetup or '10ij50' in asetup): mu_samples=[]

## Use the histogram input generated already
try: os.mkdir('data/'+configMgr.analysisName)
except: pass
...
#~~             break
#~~     setList.close()
#~~     if setName is None: setName=sigSamples[0]
#~~     #else: setName = 'Gtt'+setName.split('Gtt')[1]
#~~ 
...
if 'Test'==asetup:
    ...
    asetup = '50GeV'
#~~ if 'TestHF30'==asetup:
#~~     reduced_unc['TemplateHF'] = 1.2
#~~ if 'TestHF35'==asetup:
#~~     reduced_unc['TemplateHF'] = 1.4
...
#~~ if asetup=='50GeVUnsplit':
#~~     inputFile = open('/afs/cern.ch/atlas/project/cern/susy2/SPyRoot/susy12a_razor_p1328/HistFitter/input_root_files/bjetStream_SRnumbers/system_50GeV_newLumi.txt','r') #
#~~ elif 'Test' in asetup:
#~~     inputFile = open('/afs/cern.ch/atlas/project/cern/susy2/SPyRoot/susy12a_razor_p1328/HistFitter/input_root_files/bjetStream_SRnumbers/system_50GeV_newLumi.txt','r') #
#~~ elif asetup=='80GeVUnsplit':
#~~     inputFile = open('/afs/cern.ch/atlas/project/cern/susy2/SPyRoot/susy12a_razor_p1328/HistFitter/input_root_files/bjetStream_SRnumbers/system_80GeV_newLumi.txt','r') #
#~~ elif asetup=='50GeV':
#~~     inputFile = open('/afs/cern.ch/atlas/project/cern/susy2/SPyRoot/susy12a_razor_p1328/HistFitter/input_root_files/bjetStream_SRnumbers/system_50GeV_newLumiSplitB.txt','r') #
#~~ elif asetup=='80GeV':
#~~     inputFile = open('/afs/cern.ch/atlas/project/cern/susy2/SPyRoot/susy12a_razor_p1328/HistFitter/input_root_files/bjetStream_SRnumbers/system_80GeV_newLumiSplitB.txt','r') #
#~~ elif 'MJ' in asetup:
#~~     inputFile = open('/afs/cern.ch/atlas/project/cern/susy2/SPyRoot/susy12a_razor_p1328/HistFitter/input_root_files/MultiJet_MJ2/'+asetup+'.txt','r')
#~~ #elif doDiscovery:
#~~ elif asetup=='50GeVJES':
#~~     inputFile = open('/afs/cern.ch/atlas/project/cern/susy2/SPyRoot/susy12a_razor_p1328/HistFitter/input_root_files/bjetStream_SRnumbers/system_50GeV_newLumi_JEScomponents.txt','r') #
#~~ elif asetup=='80GeVJES':
#~~     inputFile = open('/afs/cern.ch/atlas/project/cern/susy2/SPyRoot/susy12a_razor_p1328/HistFitter/input_root_files/bjetStream_SRnumbers/system_80GeV_newLumi_JEScomponents.txt','r') #
#~~ elif '80' in asetup:
#~~     inputFile = open('/afs/cern.ch/atlas/project/cern/susy2/SPyRoot/susy12a_razor_p1328/HistFitter/input_root_files/bjetStream_SRnumbers/system_80GeV_newLumi.txt','r') #
#~~     for a in 'SR-7ej80-0bjet,SR-7ej80-1bjet,SR-7ej80-2bjet,SR-8ij80-0bjet,SR-8ij80-1bjet,SR-8ij80-2bjet'.split(','):
#~~         if asetup!=a: region_rej += [ a ]
#~~ elif '50' in asetup:
#~~     inputFile = open('/afs/cern.ch/atlas/project/cern/susy2/SPyRoot/susy12a_razor_p1328/HistFitter/input_root_files/bjetStream_SRnumbers/system_50GeV_newLumi.txt','r') #
#~~     for a in 'SR-8j50-0bjet,SR-8j50-1bjet,SR-8j50-2bjet,SR-9j50-0bjet,SR-9j50-1bjet,SR-9j50-2bjet,SR-10j50-bjetblind'.split(','):
#~~         if asetup!=a: region_rej += [ a ]
#~~ else:
#~~     print 'Did not understand setup!  Bailing out...'
#~~     sys.exit(1)
...
print 'Including backgrounds',bglist

if len(regions)==0:
    print 'Going through',len(backgrounds[ bglist[0] ]),'regions'
    for i in xrange(len(backgrounds[ bglist[0] ])): regions += [ 'UserRegion%i'%i ]
else:
...
#~~     # Remove the old ones
#~~     for asub in bgGroups[agroup]: 
#~~         if asub not in bgGroups: x = backgrounds.pop(asub)
...
#~~             #print 'ZLM1',anunc,(uncertainties.keys()[anunc-1] if anunc>0 else 'Nominal'),abg,backgrounds[abg][anunc]
#~~ 
...
#~~                 if i==0:
#~~                     #print 'ZLM',abg,anunc,areg,len(backgrounds[abg][anunc]),len(backgrounds[abg][0]),agrp,i
#~~                     if anunc!=0: backgrounds[abg][anunc][areg]=backgrounds[abg][anunc][areg]*backgrounds[abg][0][areg]
...
#~~                 if i==0: continue
#~~                 else: # Add the region to region zero (as an event yield if necessary
#~~                     if anunc==0: backgrounds[abg][anunc][lead_idx] += backgrounds[abg][anunc][areg]
#~~                     else:        backgrounds[abg][anunc][lead_idx] += backgrounds[abg][anunc][areg]
#~~             # Third, normalize if necessary
#~~             if anunc!=0: 
#~~                 #print '  renorm - sum',backgrounds[abg][anunc][lead_idx],'denom',backgrounds[abg][0][lead_idx]
...
#~~     #print 'ZLM',abg,backgrounds[abg][0]
#~~     for areg in xrange(len(regions)): numbers[0][areg] += backgrounds[abg][0][areg]
#~~ 
#~~ # Conditional groupings
#~~ # Check if we're doing an MJ analysis
#~~ crCondGroups={}
#~~ if 'Nj50-topW-0ebtag-CR' in regions:
#~~     # Check if the top CR has enough stats
#~~     if numbers[0][regions.index('Nj50-topW-1ibtag-CR')]<2 :
#~~         crCondGroups['Nj50-topW-CR']=['Nj50-topW-0ebtag-CR','Nj50-topW-1ibtag-CR']    
#~~ # End of conditional combinations
#~~ 
#~~ # Combine CRs and SRs according to conditional groupings
#~~ for agrp in crCondGroups:
#~~     regCount = 0
#~~     for areg in crCondGroups[agrp]:
#~~         if areg in regions: regCount += 1
#~~     if regCount==0:
#~~         print 'Skipping grouping of region',agrp,'from',crCondGroups[agrp],'as it does not appear in',regions
#~~         continue
#~~     
#~~     lead_idx = 0
#~~     for i,areg in enumerate( sorted(crCondGroups[agrp], key=lambda a: regions.index(a) ) ):
#~~         region_rej += [ areg ]
#~~         if i==0:
#~~             lead_idx = regions.index(areg) 
#~~     # Loop through all the backgrounds and uncertainties
...
#~~ 
#~~             # Two passes.  First change everything that needs to be into an event yield
#~~             for i,areg in enumerate( sorted( [ regions.index(a) for a in crCondGroups[agrp] ] ) ):
#~~                 # Region 0 is untouched - turn it into an event yield if necessary!
#~~                 if i==0:
#~~                     #print 'ZLM',abg,anunc,areg,len(backgrounds[abg][anunc]),len(backgrounds[abg][0]),agrp,i
#~~                     if anunc!=0: backgrounds[abg][anunc][areg]=backgrounds[abg][anunc][areg]*backgrounds[abg][0][areg]
...
#~~         regions[ lead_idx ] = agrp
#~~         break
#~~ if len(crCondGroups)>0:
#~~     print 'Will skip regions',region_rej,'after further combining into regions according to',crCondGroups
#~~ 
#~~ # Recalculate numbers
#~~ numbers = []
#~~ for aset in xrange(len(backgrounds[ backgrounds.keys()[0] ])):
...
#~~ 
#~~     if doDiscovery: validationReg = [ bkt.addChannel( 'cuts' , ['theVRcut'] , len(validations) , 0.5 , len(validations)+0.5 ) ]
#~~     else:           validationReg = [ bkt.addChannel( 'theVR' , ['theVRcut'] , len(validations) , 0.5 , len(validations)+0.5 ) ]
...
#~~     bg = bglist[i]
#~~     abg = backgrounds[ bg ]
#~~     #print 'Working on sample',bg,abg
#~~     if bg.lower()=='data':
...
#~~         if bg in mu_samples:
#~~             if '80GeV' not in asetup: 
#~~                 asamp.setNormFactor('mu_'+bg,1.,0.,5.)
#~~             else:
#~~                 asamp.setNormFactor('mu_'+bg,1.,0.,3.)
...
#~~         if len(validations)>0:
#~~             if doDiscovery: asamp.buildStatErrors( VRstat , 'theVRcut' , 'cuts' )
#~~             else:           asamp.buildStatErrors( VRstat , 'theVRcut' , 'theVR' )
...
#~~         useThis = False
#~~         for areg in xrange(len(regions)):
#~~             if len(backgrounds[abg][uncertainties[lower] ])>0 and abs(1.-backgrounds[abg][uncertainties[lower] ][ areg ])>0.001: useThis=True
#~~             if len(backgrounds[abg][uncertainties[upper] ])>0 and abs(1.-backgrounds[abg][uncertainties[upper] ][ areg ])>0.001: useThis=True
#~~         if not useThis: 
