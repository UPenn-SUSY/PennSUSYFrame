...
for hash in ${ds_list[@]} ; do
  ...
  prun \
    ...
    --outputs=${out_file} \
    --excludedSite=ANALY_FREIBURG,ANALY_AGLT2,ANALY_IN2P3-CC-T2,ANALY_MPPMU,ANALY_JINR,ANALY_RAL_XROOTD,ANALY_MANC,ANALY_INFN-FRASCATI,ANALY_INFN-ROMA1,ANALY_UAM,ANALY_RAL,ANALY_DESY-HH,ANALY_GOEGRID,ANALY_LRZ

    # --excludedSite=ANALY_FREIBURG,ANALY_AGLT2,ANALY_IN2P3-CC-T2,ANALY_MPPMU,ANALY_JINR,ANALY_RAL_XROOTD,ANALY_MANC,ANALY_INFN-FRASCATI,ANALY_INFN-ROMA1,ANALY_UAM,ANALY_RAL,ANALY_DESY-HH,ANALY_GOEGRID,ANALY_LRZ,ANALY_SWT2_CPB,ANALY_MWT2_SL6
