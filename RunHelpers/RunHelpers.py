...
syst_list = { 'do_jer':'JER'
            ...
            , 'do_zee_all_up':'ZEE_ALL_UP'
            , 'do_zee_all_down':'DO_ZEE_ALL_DOWN'
            , 'do_r12_stat_up':'DO_R12_STAT_UP'
            , 'do_r12_stat_down':'DO_R12_STAT_DOWN'
            , 'do_ps_stat_up':'DO_PS_STAT_UP'
            , 'do_ps_stat_down':'DO_PS_STAT_DOWN'
            , 'do_low_pt_up':'DO_LOW_PT_UP'
            , 'do_low_pt_down':'DO_LOW_PT_DOWN'
            , 'do_eer_up':'DO_EER_UP'
            , 'do_eer_down':'DO_EER_DOWN'
            , 'do_ms_low':'MS_LOW'
            , 'do_ms_up':'MS_UP'
            , 'do_id_low':'ID_LOW'
            , 'do_id_up':'ID_UP'
            , 'do_mu_mom_scale_low':'MU_MOM_SCALE_LOW'
            , 'do_mu_mom_scale_up':'MU_MOM_SCALE_UP'
            }
